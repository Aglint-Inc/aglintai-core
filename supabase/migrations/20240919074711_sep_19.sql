alter table "public"."candidate_portal_job" drop constraint "candidate_portal_job_application_id_fkey";

alter table "public"."candidate_portal_job" drop constraint "candidate_portal_job_job_id_fkey";

alter table "public"."candidate_portal_message" drop constraint "candidate_portal_message_application_id_fkey";

alter table "public"."interview_meeting_log" drop constraint "interview_meeting_log_meeting_id_fkey";

alter table "public"."interview_progress" drop constraint "interview_progress_application_id_fkey";

alter table "public"."interview_progress" drop constraint "interview_progress_job_id_fkey";

alter table "public"."interview_meeting_log" alter column "meeting_id" drop not null;
