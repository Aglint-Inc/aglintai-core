alter table "public"."interview_meeting" drop constraint "public_interview_meeting_request_id_fkey";
...
alter table "public"."interview_meeting" drop column "request_id";
