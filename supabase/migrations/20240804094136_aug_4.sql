drop function if exists "public"."upd_get_interview_session_data"(session_ids uuid[], company_id uuid, meet_start_date timestamp without time zone, meet_end_date timestamp without time zone);

alter table "public"."recruiter" drop column "domain_admin_email";

alter table "public"."recruiter" drop column "google_workspace_domain";

alter table "public"."recruiter" drop column "service_json";
