...
CREATE OR REPLACE FUNCTION public.scheduling_analytics_completed_interviews(recruiter_id uuid, type text DEFAULT 'day'::text, jobs uuid[] DEFAULT NULL::uuid[])
