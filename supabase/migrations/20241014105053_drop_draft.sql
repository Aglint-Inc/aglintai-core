...
alter table "public"."public_jobs" drop column "draft";

alter table "public"."public_jobs" alter column "status" set default 'published'::public_job_status;
