alter table "public"."user_chat" drop column "description";

alter table "public"."user_chat" drop column "title";

alter table "public"."user_chat" add column "content" text not null;
