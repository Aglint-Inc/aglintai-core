...
alter table "public"."public_jobs" drop column "google_indexing";
...
alter table "public"."recruiter_relation" add column "role" user_roles not null default 'admin'::user_roles;
...
drop type "public"."google_indexing";
