drop trigger if exists "interview_session_count_invalidation" on "public"."interview_session_relation";

drop function if exists "public"."trigger_interview_session_count_invalidation"();

ALTER TABLE public.interview_session
  ALTER COLUMN interviewer_cnt SET DEFAULT 0;

ALTER TABLE public.interview_session
  ADD CONSTRAINT interview_session_interviewer_cnt_check
  CHECK (interviewer_cnt >= 0);
      ...
      FOR session_id IN
        ...
        LOOP
          UPDATE 
            interview_meeting
          SET
            organizer_id = (request ->> 'assignee_id')::uuid
          WHERE
            id IN (
                SELECT 
                    meeting_id
