alter table "public"."applications" drop constraint "applications_remote_id_key";

alter table "public"."departments" drop constraint "departments_remote_id_key";

alter table "public"."office_locations" drop constraint "office_locations_remote_id_key";

alter table "public"."public_jobs" drop constraint "public_jobs_remote_id_key";

alter table "public"."recruiter_user" drop constraint "recruiter_user_remote_id_key";

alter table "public"."recruiter_relation" drop constraint "recruiter_relation_manager_id_fkey";

drop function if exists "public"."check_user_auth"();

drop function if exists "public"."greenhouse_sync"();

drop function if exists "public"."move_to_interview"(applications uuid[], sessions uuid[], requests jsonb[]);
...
drop index if exists "public"."applications_remote_id_key";

drop index if exists "public"."departments_remote_id_key";

drop index if exists "public"."office_locations_remote_id_key";

drop index if exists "public"."public_jobs_remote_id_key";

drop index if exists "public"."recruiter_user_remote_id_key";
...
alter table "public"."public_jobs" drop column "remote_sync_time";

alter table "public"."recruiter_user" drop column "is_calendar_connected";
