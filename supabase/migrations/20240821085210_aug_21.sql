...
alter table "public"."office_locations" alter column "name" drop not null;

alter table "public"."recruiter_user" add column "is_calendar_connected" boolean not null default false;
