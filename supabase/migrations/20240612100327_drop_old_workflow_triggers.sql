...
drop trigger if exists "after_update_candidate_request_availability" on "public"."candidate_request_availability";
...
drop function if exists "public"."workflow_log_on_update_candidate_request_availability"();