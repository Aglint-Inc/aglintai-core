alter table "public"."scheduling-agent-chat-history" alter column "application_id" drop default;

alter table "public"."scheduling-agent-chat-history" alter column "application_id" drop not null;
