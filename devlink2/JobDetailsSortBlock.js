...
import { JobDetailsSortOption } from "./JobDetailsSortOption";
import * as _utils from "./utils";
import _styles from "./JobDetailsSortBlock.module.css";

export function JobDetailsSortBlock({
  ...
  return (
    <_Component className={_utils.cx(_styles, "cl-filters")} tag="div">
      ...
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "jdet-sort-top")}
          tag="div"
        >
          <_Builtin.Block
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "jdet-sort-content")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "jdet-sort-inner")}
            tag="div"
          >
            <_Builtin.Block
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "jdet-sort-options")}
              tag="div"
            >
              <JobDetailsSortOption isAscending={true} />
              <JobDetailsSortOption />
            </_Builtin.Block>
            <_Builtin.Block
              className={_utils.cx(_styles, "sort-apply-btn")}
              tag="div"
              {...onclickApply}
            >
              <_Builtin.Block
