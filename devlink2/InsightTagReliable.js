...
import _styles from "./InsightTagReliable.module.css";
...
export function InsightTagReliable({
  ...
  return (
    <_Component className={_utils.cx(_styles, "insight-tag")} tag="div">
      <_Builtin.Block
        ...
        data-w-id="a5b106de-2998-1705-53ba-c2270cc46ddc"
        tag="div"
      >
        <_Builtin.Image
      ...
      >
        ...
        >
          {
            "Dependable and consistent in delivering results. Can be trusted to fulfill responsibilities with diligence."
          }
        </_Builtin.Block>
      </_Builtin.Block>
    </_Component>
