...
export function ListItemSkeletalLoader({
  ...
  return (
    <_Component className={_utils.cx(_styles, 'cv-list-row')} tag='div'>
      ...
      >
        <_Builtin.Block
          className={_utils.cx(_styles, 'skeletal-wrapper', 'h-14', '_w-14')}
          tag='div'
        >
          <_Builtin.Block
      ...
      >
        ...
        >
          <_Builtin.Block
            className={_utils.cx(_styles, 'skeletal-wrapper', 'h-14', '_w-240')}
            tag='div'
          >
            <_Builtin.Block
              className={_utils.cx(_styles, 'skeletal-block')}
