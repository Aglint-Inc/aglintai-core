...
export function OpenInvitationLink({
  as: _Component = _Builtin.Block,
  textDesc = "Hi Raimon, pick an option that suits you best and take the first step towards joining our team. We look forward to meeting you!",
  slotInviteLinkCard,
  onClickAskOptions = {},
  slotButtonPrimary,
  ...
  return (
    ...
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "div-block-1202")}
        tag="div"
      >
        <_Builtin.Block
        ...
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "div-block-1141")}
            tag="div"
          >
            ...
            <_Builtin.Block
              ...
              tag="div"
            >
              {"Pick your suitable option for interview"}
            </_Builtin.Block>
            <_Builtin.Block
          ...
          <_Builtin.Block
            ...
            tag="div"
          >
            {isNotFindingTextVisible ? (
              <_Builtin.Block tag="div">
                {"Not finding a suitable option. "}
                <_Builtin.Span
                  className={_utils.cx(
                    _styles,
                    "text-blue-500",
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-1163", "mt-90")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "powered-footer-wrap", "mt-0")}
            tag="div"
          >
            <_Builtin.Block
