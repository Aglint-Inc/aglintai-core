...
import _styles from "./InsightTagLeader.module.css";
...
export function InsightTagLeader({
  ...
  return (
    <_Component className={_utils.cx(_styles, "insight-tag")} tag="div">
      <_Builtin.Block
        ...
        data-w-id="3038a02d-fcbc-a8f7-9002-13ebb05867c3"
        tag="div"
      >
        <_Builtin.Image
          ...
          height="auto"
          alt=""
          src="https://uploads-ssl.webflow.com/651419e73ebbb12148f96ccc/65672e8b5efa49a883935f00_%F0%9F%8C%9F.svg"
        />
        <_Builtin.Block tag="div">{"Leader"}</_Builtin.Block>
      </_Builtin.Block>
      <_Builtin.Block
      ...
      >
        ...
        >
          {
            "Possesses strong leadership qualities, capable of guiding and motivating others toward common goals."
          }
        </_Builtin.Block>
      </_Builtin.Block>
    </_Component>
