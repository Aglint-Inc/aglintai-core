...
export function InterviewMembersCard({
  ...
  return (
    ...
    >
      ...
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-1070", "round")}
          tag="div"
        >
          {slotMemberImage}
        </_Builtin.Block>
      ...
      {isTrainingVisible ? (
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-1174", "right-side")}
          tag="div"
        >
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "div-block-1175", "hide")}
        tag="div"
      >
        <_Builtin.Block tag="div">
          <_Builtin.Block
          ...
          >
            ...
            >
              ...
              <_Builtin.Block
                ...
                data-w-id="8a43fce8-d000-b90a-d206-5721d764fe1c"
                tag="div"
              >
                {"Paused"}
              </_Builtin.Block>
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <_Builtin.Block tag="div">{"Resume User"}</_Builtin.Block>
            </_Builtin.Block>
            <_Builtin.Block
              className={_utils.cx(_styles, "div-block-1102", "cursor-pointer")}
              tag="div"
