...
export function RecLoginPage({
  ...
  return (
    <_Component className={_utils.cx(_styles, "sl-main-wrapper")} tag="div">
      <_Builtin.Block
        className={_utils.cx(_styles, "sl-login-block", "gap-80")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "sl-logo-block", "mb--90")}
          tag="div"
        >
          <_Builtin.HtmlEmbed
        ...
        >
          ...
          >
            ...
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "sl-auth-link-block")}
                tag="div"
                {...onclickGoogle}
              >
              ...
              >
                <_Builtin.Block tag="div">
                  <_Builtin.Image
                    ...
                    height="auto"
                    alt=""
                    src="https://uploads-ssl.webflow.com/651419e73ebbb12148f96ccc/654a42732b56a1e41e2c2bc8_LinkedIn%20-%20png%20-%2012px.png"
                  />
                </_Builtin.Block>
                <_Builtin.Block
                  className={_utils.cx(_styles, "fw-semibold")}
