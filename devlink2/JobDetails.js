...
import { JobDetailsStatus } from "./JobDetailsStatus";
    ...
    <_Component className={_utils.cx(_styles, "job-details-wrapper")} tag="div">
      ...
      >
        ...
        >
          ...
          >
            {slotJobStatus ?? (
              <JobDetailsStatus onClickEditJobs={onClickEditJobs} />
            )}
          </_Builtin.Block>
        </_Builtin.Block>
      </_Builtin.Block>
          ...
          <_Builtin.Block className={_utils.cx(_styles, "jdet-tabs")} tag="div">
            {slotTabs ?? (
              <JobDetailsTabs
                ...
                onClickQualified={onClickQualified}
                countQualified={countQualified}
                onClickDisqualified={onClickDisqualified}
                countDisqualified={countDisqualified}
              />
            )}
          </_Builtin.Block>
          <_Builtin.Block
                ...
                >
                  {slotCandidatesList ?? (
                    <>
                      <CandidateListItem />
                      <_Builtin.Block
                        className={_utils.cx(_styles, "cv-list-row", "item")}
                        tag="div"
                      >
                        <_Builtin.Block
                          className={_utils.cx(
                        ...
                        >
                          <_Builtin.Block
                            className={_utils.cx(
                              _styles,
                              "cv-list-res-score-icon"
                            )}
                            tag="div"
                          />
                          <_Builtin.Block tag="div">{"32%"}</_Builtin.Block>
                        </_Builtin.Block>
                        <_Builtin.Block
                          className={_utils.cx(
                            _styles,
