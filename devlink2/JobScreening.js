      ...
      <_Builtin.Block className={_utils.cx(_styles, "div-block-271")} tag="div">
        ...
        >
          ...
          >
            ...
            >
              <_Builtin.HtmlEmbed
                className={_utils.cx(_styles, "icon", "hide")}
          ...
          >
            ...
            >
              {isTopbarVisible ? (
                ...
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "cli-column")}
                    tag="div"
                  >
                    <_Builtin.Block
                      className={_utils.cx(_styles, "cli-checkbox")}
                      tag="div"
                      {...selectAllCheckbox}
                    >
                      <_Builtin.Block
                  ...
                  <_Builtin.Block
                    className={_utils.cx(_styles, "list-main-info", "top-bar")}
                    tag="div"
                  >
                    <_Builtin.Block
                      className={_utils.cx(
