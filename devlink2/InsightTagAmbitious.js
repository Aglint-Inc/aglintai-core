...
import _styles from "./InsightTagAmbitious.module.css";
...
export function InsightTagAmbitious({
  ...
  return (
    <_Component className={_utils.cx(_styles, "insight-tag")} tag="div">
      <_Builtin.Block
        ...
        data-w-id="1fc745f6-abd1-5e5f-1fb5-55d8776e6d6d"
        tag="div"
      >
        <_Builtin.Image
      ...
      >
        ...
        >
          {
            "Driven and goal-oriented, demonstrating a strong desire to achieve success and make significant progress in their endeavors."
          }
        </_Builtin.Block>
      </_Builtin.Block>
    </_Component>
