...
import { TeamInvitesBlock } from "./TeamInvitesBlock";
import * as _utils from "./utils";
import _styles from "./TeamPendingInvites.module.css";
...
export function TeamPendingInvites({
  ...
  return (
    <_Component className={_utils.cx(_styles, "cs-pending-invites")} tag="div">
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "pi-user-wrapper")}
        tag="div"
      >
        {slotList ?? <TeamInvitesBlock />}
      </_Builtin.Block>
    </_Component>
  );
}
