...
export function CandidateHistoryCard({
  ...
  return (
    <_Component
      ...
      {...onClickCard}
    >
      <_Builtin.Block className={_utils.cx(_styles, "div-block-820")} tag="div">
        <_Builtin.Block
          className={_utils.cx(_styles, "text-block-32", "width-90")}
          tag="div"
        >
          {textHeader}
        </_Builtin.Block>
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-821")}
          data-w-id="c41adfbc-d6ae-0c69-8c9b-ea0c5352da5f"
          tag="div"
        >
          <_Builtin.HtmlEmbed
            className={_utils.cx(_styles, "icons", "mr--10")}
