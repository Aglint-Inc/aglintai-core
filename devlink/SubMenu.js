...
export function SubMenu({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "relative", "mt-12", "flex")}
      tag="div"
      {...onClickMenu}
    >
