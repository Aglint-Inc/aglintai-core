...
export function NavMenuBottom({
  ...
  return (
    ...
    >
      ...
      <_Builtin.Link
        className={_utils.cx(_styles, "", "subnav-link", "hide")}
        button={false}
        options={{
          href: "#",
        }}
