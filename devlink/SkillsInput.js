...
import _styles from "./SkillsInput.module.css";
...
export function SkillsInput({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "skill-input-wrappers")}
      tag="div"
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "slot-input-skills")}
        tag="div"
      >
        <_Builtin.Block tag="div">{slotInput}</_Builtin.Block>
      </_Builtin.Block>
      <_Builtin.Block
        className={_utils.cx(_styles, "saved-cancel-skill-wrappers")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "save-skill-wrappers-tick")}
          tag="div"
          {...onClickSave}
        >
          <_Builtin.HtmlEmbed
