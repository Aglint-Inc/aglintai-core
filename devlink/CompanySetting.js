    ...
    >
      <_Builtin.Block className={_utils.cx(_styles, "div-block-344")} tag="div">
        ...
        >
          ...
          {isSaved ? (
            <_Builtin.Block
              className={_utils.cx(_styles, "slot-saved")}
              tag="div"
            >
              <_Builtin.HtmlEmbed
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "rd-jobs-wrapper-2", "hide")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "rd-company-wrapper")}
          tag="div"
        >
          <_Builtin.Block
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "rd-email-temp-wrapper")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "cdd-template-company-2")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "div-block-job-wrapper")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(
                ...
                >
                  ...
                  >
                    ...
                    />
                    <_Builtin.Block
                      className={_utils.cx(_styles, "div-block-343")}
                      tag="div"
                    >
                      <_Builtin.Block
                        className={_utils.cx(
                      ...
                      >
                        <_Builtin.Block
                          ...
                          data-w-id="690c5ee4-d401-eca9-addf-13eb4b5bf317"
                          tag="div"
                          tabIndex="0"
                        >
                          <_Builtin.Block
                        ...
                        <_Builtin.Block
                          className={_utils.cx(_styles, "aui-button-wrap")}
                          data-w-id="690c5ee4-d401-eca9-addf-13eb4b5bf322"
                          tag="div"
                          tabIndex="0"
                        >
                          <_Builtin.Block
                    ...
                    <_Builtin.Block
                      className={_utils.cx(_styles, "rd-company-edit-main")}
                      tag="div"
                    >
                      <_Builtin.Block
                        className={_utils.cx(
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <_Builtin.FormWrapper
                                  className={_utils.cx(_styles, "form-block-9")}
                                >
                                  <_Builtin.FormForm
                                    className={_utils.cx(_styles, "form-9")}
                                    name="email-form"
                                ...
                                >
                                  ...
                                  >
                                    <_Builtin.FormTextInput
                                      ...
                                      name="email-2"
                                      data-name="Email 2"
                                      placeholder="Stripe, 510 Townsend Street, San Francisco CA 94103"
                                      type="email"
                                      disabled={false}
                                      required={false}
                                      id="email-2"
                            ...
                            >
                              ...
                              <_Builtin.Block
                                className={_utils.cx(_styles, "div-block-349")}
                                tag="div"
                              >
                                <_Builtin.Image
                                  ...
                                  >
                                    ...
                                    >
                                      <_Builtin.FormTextInput
                                        ...
                                        name="email-2"
                                        data-name="Email 2"
                                        placeholder="www.linkedin.com/microsoft"
                                        type="email"
                                        disabled={false}
                                        required={false}
                                        id="email-2"
                                  ...
                                  >
                                    ...
                                    >
                                      <_Builtin.FormTextInput
                                        ...
                                        name="email-2"
                                        data-name="Email 2"
                                        placeholder="www.instagram.com/microsoft"
                                        type="email"
                                        disabled={false}
                                        required={false}
                                        id="email-2"
                                  ...
                                  >
                                    ...
                                    >
                                      <_Builtin.FormTextInput
                                        ...
                                        name="email-2"
                                        data-name="Email 2"
                                        placeholder="www.youtube.com/microsoft"
                                        type="email"
                                        disabled={false}
                                        required={false}
                                        id="email-2"
                                  ...
                                  >
                                    ...
                                    >
                                      <_Builtin.FormTextInput
                                        ...
                                        name="email-2"
                                        data-name="Email 2"
                                        placeholder="www.twitter.com/microsoft"
                                        type="email"
                                        disabled={false}
                                        required={false}
                                        id="email-2"
                                  ...
                                  >
                                    ...
                                    >
                                      <_Builtin.FormTextInput
                                        ...
                                        name="email-2"
                                        data-name="Email 2"
                                        placeholder="www.facebook.com/microsoft"
                                        type="email"
                                        disabled={false}
                                        required={false}
                                        id="email-2"
                                  ...
                                  >
                                    ...
                                    >
                                      <_Builtin.FormTextInput
                                        ...
                                        name="email-2"
                                        data-name="Email 2"
                                        placeholder="www.tiktok.com/microsoft"
                                        type="email"
                                        disabled={false}
                                        required={false}
                                        id="email-2"
                ...
                <_Builtin.Block
                  className={_utils.cx(
                    _styles,
                    "rd-com-detail-edit-btn",
                    "clickable"
                  )}
                  data-w-id="690c5ee4-d401-eca9-addf-13eb4b5bf3b8"
                  tag="div"
                >
                  <_Builtin.Block
              ...
              <_Builtin.Block
                className={_utils.cx(_styles, "div-block-293-card")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "div-name-card")}
                  tag="div"
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "text-width-comp")}
                    tag="div"
                  >
                    {"Company name"}
                  </_Builtin.Block>
                  <_Builtin.Block
                    className={_utils.cx(_styles, "company-text-2")}
                    tag="div"
                  >
                    {"Microsoft Inc"}
                  </_Builtin.Block>
      ...
      >
        ...
        >
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "cdd-template-block-2")}
              tag="div"
            >
              <_Builtin.Block
              ...
              >
                ...
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "rd-email-edit-wrapper-2")}
                    tag="div"
                  >
                    <_Builtin.HtmlEmbed
                      className={_utils.cx(_styles, "hide")}
                      ...
                      >
                        ...
                        >
                          <_Builtin.Block
                            ...
                            data-w-id="690c5ee4-d401-eca9-addf-13eb4b5bf3dc"
                            tag="div"
                            tabIndex="0"
                          >
                            <_Builtin.Block tag="div">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <_Builtin.Block
                              className={_utils.cx(_styles, "input-3", "para")}
                              tag="div"
                            >
                              <_Builtin.FormWrapper
                                className={_utils.cx(_styles, "form-block-9")}
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <_Builtin.FormWrapper
                                  className={_utils.cx(_styles, "form-block-8")}
                                >
                                  <_Builtin.FormForm
                                    className={_utils.cx(_styles, "form-8")}
                                    name="email-form-2"
                                  ...
                                  >
                                    ...
                                    >
                                      {
                                        "Thank you for your interest in the software engineer position at Dunder Mifflin. After careful consideration, we regret to inform you that we have chosen another candidate for the role.We appreciate your application and wish you the best in your job search."
                                      }
                                    </_Builtin.Paragraph>
                                  </_Builtin.FormForm>
                                  <_Builtin.FormSuccessMessage
                          ...
                          <_Builtin.Block
                            className={_utils.cx(_styles, "toggle-dropdown-2")}
                            tag="div"
                          >
                            <_Builtin.Block
                              className={_utils.cx(
                                _styles,
                                "toggle-dropdown-toggle-3",
                                "company"
                              )}
                              data-w-id="690c5ee4-d401-eca9-addf-13eb4b5bf43d"
                              tag="div"
                            >
                              <_Builtin.Block tag="div">
                                <_Builtin.Block
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <_Builtin.Block
                              className={_utils.cx(_styles, "div-block-350")}
                              tag="div"
                            >
                              <_Builtin.Image
                                loading="lazy"
              ...
              <_Builtin.Block
                className={_utils.cx(_styles, "div-block-352")}
                tag="div"
              >
                <_Builtin.Image
                  loading="lazy"
                      ...
                      >
                        ...
                        >
                          <_Builtin.Block
                            ...
                            data-w-id="690c5ee4-d401-eca9-addf-13eb4b5bf474"
                            tag="div"
                            tabIndex="0"
                          >
                            <_Builtin.Block tag="div">
                        ...
                        >
                          ...
                          >
                            <_Builtin.Block
                              ...
                              data-w-id="690c5ee4-d401-eca9-addf-13eb4b5bf4d9"
                              tag="div"
                            >
                              <_Builtin.Block tag="div">
                                <_Builtin.Block
                      ...
                      >
                        ...
                        >
                          <_Builtin.Block
                            ...
                            data-w-id="690c5ee4-d401-eca9-addf-13eb4b5bf510"
                            tag="div"
                            tabIndex="0"
                          >
                            <_Builtin.Block tag="div">
                        ...
                        >
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <_Builtin.Block tag="div">
                                    {
                                      "Congratulations!You're our Chosen Candidate at Tesla"
                                    }
                                  </_Builtin.Block>
                                </_Builtin.FormForm>
                                <_Builtin.FormSuccessMessage
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <br />
                                      {
                                        "You got the job! Welcome to [Company Name] as our new [Job Title].Looking forward to working together! we will inform more details via email."
                                      }
                                      <br />
                                      <br />
                                    </_Builtin.Paragraph>
                          ...
                          >
                            <_Builtin.Block
                              ...
                              data-w-id="690c5ee4-d401-eca9-addf-13eb4b5bf575"
                              tag="div"
                            >
                              <_Builtin.Block tag="div">
                                <_Builtin.Block
                ...
                >
                  {slotEmailTemplate ?? (
                    <>
                      ...
                      >
                        <_Builtin.Block
                          className={_utils.cx(_styles, "custome-div")}
                          tag="div"
                        >
                          <_Builtin.HtmlEmbed
                            className={_utils.cx(_styles, "icons")}
