...
import _styles from "./RevertChangesModal.module.css";
...
export function RevertChangesModal({
  ...
  return (
    <_Component className={_utils.cx(_styles, "revert-changes-wrap")} tag="div">
      <_Builtin.Block
        className={_utils.cx(_styles, "revertchange-title-wrap")}
        tag="div"
      >
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "revert-change-text-wrap")}
        tag="div"
      >
        <_Builtin.Block tag="div">
          {"The changes will be reverted back to last published state"}
        </_Builtin.Block>
      </_Builtin.Block>
      <_Builtin.Block
        className={_utils.cx(_styles, "revert-btn-wrap")}
        tag="div"
      >
        <_Builtin.Block
