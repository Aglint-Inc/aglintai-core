...
export function InterviewScreenFeedback({
  ...
  return (
    <_Component
      ...
      tag="div"
    >
      <_Builtin.Block className={_utils.cx(_styles, "div-block-469")} tag="div">
        <_Builtin.Block
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "container-878")}
          tag="div"
        >
          {slotFeedbackCard ?? (
            <_Builtin.Block
            ...
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "if-wrapper")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "if-block")}
                  tag="div"
                >
                  <_Builtin.Block
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "bottom-sticky-footer")}
        tag="div"
      >
        <_Builtin.Block
