...
import _styles from "./ImportCandidatesModal.module.css";

export function ImportCandidatesModal({
  as: _Component = _Builtin.Block,
  onClickDownloadSample = {},
  onClickImportFromFiles = {},
  onClickAddManually = {},
  isImportFilesActive = true,
  isAddManuallyActive = false,
  onClickBrowse = {},
  onClickClose = {},
  propsDrag = {},
  slotImport,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "fw-semibold", "z-index-5")}
            tag="div"
          >
            {"Import from files"}
          </_Builtin.Block>
          {isImportFilesActive ? (
            <_Builtin.Block
              className={_utils.cx(_styles, "ic-tab-link-highlight")}
              tag="div"
            />
          ) : null}
        </_Builtin.Block>
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "ic-import-main")}
        tag="div"
      >
        {slotImport ?? (
          <ImportCandidates
            onClickDownloadSample={onClickDownloadSample}
