      ...
      <_Builtin.Block className={_utils.cx(_styles, "inbox-list")} tag="div">
        ...
        >
          ...
          >
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "il-ticket-id")}
              tag="div"
            >
              {"Ticket ID"}
            </_Builtin.Block>
            <_Builtin.Block
              className={_utils.cx(_styles, "il-issue")}
              tag="div"
            >
              {"Issue"}
            </_Builtin.Block>
            <_Builtin.Block
              className={_utils.cx(_styles, "il-priority", "top")}
              tag="div"
            >
              {"Priority"}
            </_Builtin.Block>
            <_Builtin.Block
              className={_utils.cx(_styles, "il-assignee", "top", "assignee")}
              tag="div"
            >
              {"Assignee"}
            </_Builtin.Block>
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "il-job-info", "top")}
              tag="div"
            >
              {"Job Info"}
            </_Builtin.Block>
            <_Builtin.Block
              className={_utils.cx(_styles, "il-status", "top")}
              tag="div"
            >
              {"Status"}
            </_Builtin.Block>
            <_Builtin.Block
              className={_utils.cx(_styles, "il-create-date", "top")}
              tag="div"
            >
              {"Create Date"}
            </_Builtin.Block>
