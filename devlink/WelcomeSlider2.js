...
import _styles from "./WelcomeSlider2.module.css";
...
export function WelcomeSlider2({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "auth-right-block", "login-sign")}
      tag="div"
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "auth-cta-block", "sign-up")}
        tag="div"
      >
        <_Builtin.Block
        ...
        >
          ...
          >
            {"Welcome Back"}
            <br />
            {"Log in to Aglint for Employers"}
          </_Builtin.Block>
          <_Builtin.Block
            className={_utils.cx(_styles, "ju-header-description")}
            tag="div"
          >
            {"Use Google or LinkedIn, or enter your registered email below."}
          </_Builtin.Block>
        </_Builtin.Block>
        <_Builtin.Block
        ...
        >
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "auth-form-block", "login")}
              tag="div"
            >
              <_Builtin.Block
