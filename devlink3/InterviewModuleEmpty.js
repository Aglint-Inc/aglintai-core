...
import _styles from "./InterviewModuleEmpty.module.css";

export function InterviewModuleEmpty({
  as: _Component = _Builtin.Block,
  onClickCreateModule = {},
}) {
  return (
    <_Component className={_utils.cx(_styles, "div-block-1374")} tag="div">
      <_Builtin.Block
        className={_utils.cx(_styles, "div-block-1375")}
        tag="div"
      >
        <_Builtin.HtmlEmbed
        ...
        <_Builtin.Block className={_utils.cx(_styles, "fw-semibold")} tag="div">
          {"No Interview Modules found"}
        </_Builtin.Block>
      </_Builtin.Block>
      <_Builtin.Block className={_utils.cx(_styles, "text-grey-600")} tag="div">
        {
          "You need atleast one interview module created in order to add a session in interview plan."
        }
      </_Builtin.Block>
      <_Builtin.Block
        className={_utils.cx(
