...
import _styles from './ButtonDangerDefaultRegular.module.css';

export function ButtonDangerDefaultRegular({
  ...
  return (
    ...
    >
      <_Builtin.Block
        className={_utils.cx(_styles, 'button-block', 'danger', 'default')}
        tag='div'
      >
