...
import _styles from './ButtonDarkDefaultRegular.module.css';

export function ButtonDarkDefaultRegular({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, 'button-wrapper', 'dark', 'default')}
      tag='div'
      {...buttonProps}
    >
      <_Builtin.Block
        className={_utils.cx(_styles, 'button-block', 'dark', 'default')}
        tag='div'
      >
