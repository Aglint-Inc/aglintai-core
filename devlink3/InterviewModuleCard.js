...
export function InterviewModuleCard({
  ...
  return (
    <_Component className={_utils.cx(_styles, "interview_module")} tag="div">
      ...
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-805")}
          tag="div"
        >
          <_Builtin.Block
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-803")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "div-block-802")}
            tag="div"
          >
            <_Builtin.Block tag="div">{textMemberfromCount}</_Builtin.Block>
            <_Builtin.Block
