  ...
  public: {
    Tables: {
      ...
      new_application: {
        ...
        Relationships: [
          {
            foreignKeyName: "new_application_candidate_file_id_fkey"
            columns: ["candidate_file_id"]
            isOneToOne: false
            referencedRelation: "new_candidate_files"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "new_application_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "new_candidate"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "new_application_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
            referencedRelation: "public_jobs"
            referencedColumns: ["id"]
