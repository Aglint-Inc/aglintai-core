            ...
            body={visibleRows.map((row, index) => {
              ...
              return (
                <TableRow
                  ...
                  onClick={() => {
                    setPeopleDetail({ ...peopleDetail, bgcolor: row.bgcolor });
                    router.push(
                      `?contact_id=${row.application_id}`,
                      undefined,
                      {
                        shallow: true,
                      },
                ...
                >
                  ...
                  <EnhancedCell>
                    <Stack direction={'row'} alignItems={'center'} spacing={2}>
                      ...
                      <Typography variant='inherit' className='one-line-clamp'>
                        {row.last_name
                  ...
                  <EnhancedCell>{row.job_title || '--'}</EnhancedCell>
