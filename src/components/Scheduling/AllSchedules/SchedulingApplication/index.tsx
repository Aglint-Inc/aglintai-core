...
import { setSelectedApplication, useInterviewSchedulingStore } from '../store';
...
function SchedulingApplication() {
  ...
  const { selectedApplication, applicationList, initialLoading } =
  ...
  let allPlans =
    selectedApplication?.public_jobs?.interview_plan?.plan?.filter(
      (plan) => !plan.isBreak
    ) || [];
            ...
            selectedApplication.public_jobs.interview_plan && (
              <>
                <SchedulingFlow
                  ...
                  textLocation={
                    selectedApplication.public_jobs.location || '--'
                  }
                  slotCandidateImage={
                    <MuiAvatar
                      level={getFullName(
