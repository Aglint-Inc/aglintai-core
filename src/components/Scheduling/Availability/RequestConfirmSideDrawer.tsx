...
// import { setInterviewers, useAvailableStore } from './store';
...
const RequestConfirmSideDrawer = ({ onClose }) => {
  return <div>RequestConfirmSideDrawer</div>;
};

export default RequestConfirmSideDrawer;
