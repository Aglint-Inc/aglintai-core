      ...
      <ScheduleTabOverview
        ...
        slotMembers={confirmedUsers?.map((item) => {
          ...
          const weeklyHours = allMeetings.reduce((acc, curr) => {
            return (
              acc + calculateHourDifference(curr.start_time, curr.end_time)
            );
          }, 0);
          ...
          return (
            <>
              <MembersList
                ...
                isReverseShadow={
                  item.interview_session_relation.training_type ===
                  'reverse_shadow'
                }
                isShadow={
        ...
        slotScheduleCard={
          <ScheduleCard
            ...
            textDuration={`${dayjs(
              ...
              'hh:mm A',
            )} - ${dayjs(schedule.interview_meeting.end_time).format('hh:mm A')} ${convertTimeZoneToAbbreviation(userTzDayjs.tz.guess())}`}
            slotPlatformIcon={
              <IconScheduleType
              ...
              slotImage={
                ...
                >
                  <circle
                    ...
                    cy='20'
                    r='20'
                    fill='url(#pattern0_10048_118283)'
                  />
                  <defs>
                    <pattern
                      id='pattern0_10048_118283'
                      patternContentUnits='objectBoundingBox'
                      width='1'
                      height='1'
                    >
                      <use
                        href='#image0_10048_118283'
                        transform='scale(0.00625)'
                      />
                    </pattern>
                    <image
                      id='image0_10048_118283'
                      width='160'
                      height='160'
