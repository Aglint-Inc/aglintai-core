  ...
  drop function if exists find_avail_api_details_updated_2 (
    job_id uuid,
    recruiter_id uuid
  );

  CREATE OR REPLACE FUNCTION find_avail_api_details_updated_2 (
    job_id uuid,
    recruiter_id uuid
  ) RETURNS TABLE (
  ...
  find_avail_api_details_updated_2 (
        'b6fe81e7-759b-4947-b950-a8d8ec0c70f0'::uuid,
