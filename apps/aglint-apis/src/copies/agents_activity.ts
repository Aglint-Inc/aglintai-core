export const agent_activities = {
  phone_agent: {
    ...
    tools: {
      ...
      'schedule-call': {
        req_scheduled_call: `{candidate} has requested to schedule a call on {time_format}.`,
      ...
      'find-interview-slots': {
        ...
        failed_to_fetch_slots: `An error occurred while fetching slots for {date_format}. {err_msg}`,
      },
      'schedule-interview-slot': {
        req_slot_on_time: `{candidate} requested an interview slot on {time_format} `,
        no_slots_found: `{candidate} got empty slot at {time_format}`,
        scheduled_sucess: `Interview scheduled for {candidate} at {time_format}`,
        failed_to_schedule: `Unable to schedule the interview for {date_format}. {err_msg}`,
      },
      'cancel-interview': {
        candidate_req: `{candidate} requested to cancel the scheduled interview`,
        sucessessfull_cancel: `Scheduled interview successfully cancelled`,
        failed_cancel_interview: `Failed to cancel the scheduled interview. {err_msg}`,
      },
    },
    //
  },
