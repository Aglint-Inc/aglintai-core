...
const func = async (
  payload: TargetApiPayloadType<'interviewEnd_slack_rShadowTraineeForMeetingAttendence'>,
) => {
...
export const POST = createPostRoute(
  TargetApiSchema.interviewEnd_slack_rShadowTraineeForMeetingAttendence,
  func,
);
