...
import { onQualifiedEmailApproverSchema } from '@aglint/shared-types/src/aglint-mail/api_schema';
import {
  ClientError,
...
export async function POST(req: Request) {
  ...
  try {
    const parsed_body = v.parse(onQualifiedEmailApproverSchema, req_body.meta);
