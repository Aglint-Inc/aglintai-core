...
type EmailType = ReactTempPayload<'availabilityReqResend_email_candidate'>;
...
export const dummy: EmailType = {
  ...
  subject: '',
  availabilityReqLink: `{process.env.NEXT_PUBLIC_CLIENT_APP_URL}/scheduling/request-availability/{req_body.avail_req_id}`,
};
