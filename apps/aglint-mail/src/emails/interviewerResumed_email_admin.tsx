...
// export dummy
export const dummy: EmailTemplateAPi<'interviewerResumed_email_admin'>['react_email_placeholders'] =
  {
    subject: '',
...
}: EmailTemplateAPi<'interviewerResumed_email_admin'>['react_email_placeholders']) => {
