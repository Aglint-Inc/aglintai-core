...
export const dummy: EmailType['react_email_placeholders'] = {
  emailBody: `<p>Dear {{ candidateName }},</p><p>I hope this email finds you well.</p><p>This is a friendly reminder about your upcoming online interview with {{ companyName }} for the {{ jobTitle }} position.</p><p>Looking forward to speaking with you.</p><p>Best regards,</p><p>{{ organizerName }}<br>{{ companyName}}</p><p></p>`,
  companyLogo:
