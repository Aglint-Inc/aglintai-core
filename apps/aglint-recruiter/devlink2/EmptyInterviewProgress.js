...
export function EmptyInterviewProgress({
  ...
  return (
    <_Component className={_utils.cx(_styles, "div-block-1480")} tag="div">
      <_Builtin.Block
