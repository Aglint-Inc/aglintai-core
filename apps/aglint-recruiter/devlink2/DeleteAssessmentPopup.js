...
import _styles from "./DeleteAssessmentPopup.module.css";

export function DeleteAssessmentPopup({
  ...
  return (
    ...
    >
      ...
      <_Builtin.Block className={_utils.cx(_styles, "popup_body")} tag="div">
        ...
        >
          {
            "By Deleting this assessment all the questions will be removed and will no longer accesssible."
          }
        </_Builtin.Block>
      </_Builtin.Block>
