...
import _styles from "./CalendarPick.module.css";
...
export function CalendarPick({
  ...
  return (
    <_Component className={_utils.cx(_styles, "date-pick-wrap")} tag="div">
      {isArrowVisible ? (
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "div-block-1718")}
        tag="div"
        {...styleScrollProps}
      >
        {slotDatePicker ?? (
          <>
            <SlotComp componentName="DatePicker" />
            <SlotComp componentName="DatePicker" />
            <SlotComp componentName="DatePicker" />
          </>
        )}
