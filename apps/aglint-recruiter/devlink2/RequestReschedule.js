    ...
    <_Component className={_utils.cx(_styles, "rr-wrapper")} tag="div">
      ...
      <_Builtin.Block tag="div">
        ...
        {isCancelWarningVisible ? (
          <_Builtin.Block
            className={_utils.cx(_styles, "rr-warning-wrap")}
            tag="div"
          >
            <_Builtin.HtmlEmbed
            ...
            />
            <_Builtin.Block
              className={_utils.cx(_styles, "cancel-text-wrap")}
              tag="div"
            >
              <Text
                weight=""
                content="If you wish to keep this job opportunity open, consider opting for rescheduling rather than canceling."
              />
              <_Builtin.Block
                className={_utils.cx(_styles, "reschedule-btn-wrap")}
                tag="div"
                {...onClickTryReschedulingNow}
              >
                <Text content="Reschedule" weight="" />
              </_Builtin.Block>
            </_Builtin.Block>
          </_Builtin.Block>
        ) : null}
