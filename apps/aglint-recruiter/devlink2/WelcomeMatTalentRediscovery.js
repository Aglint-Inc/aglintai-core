      ...
      >
        ...
        <_Builtin.Block className={_utils.cx(_styles, "wm_cards")} tag="div">
          <_Builtin.Block
            ...
            tag="div"
          >
            <Text weight="bold" content="Revive Past Applications" />
            <Text
              weight=""
              content="Rediscover talent in your candidate pool. AI matches past applicants with current job openings, ensuring no talent goes unnoticed."
              color="neutral"
            />
          </_Builtin.Block>
          <_Builtin.Block
            ...
            tag="div"
          >
            <Text weight="bold" content="Semantic Search" />
            <Text
              weight=""
              content="Our intelligent search understands job requirements beyond keywords. It brings candidates whose skills truly align with the role."
              color="neutral"
            />
          </_Builtin.Block>
          <_Builtin.Block
            ...
            tag="div"
          >
            <Text weight="bold" content="Effortless Matching" />
            <Text
              weight=""
              content="Simply input your job criteria, and let our AI do the rest. It analyzes past applications to suggest candidates who are not just qualified, but potentially ideal for the role."
              color="neutral"
            />
          </_Builtin.Block>
          <_Builtin.Block
            ...
            tag="div"
          >
            <Text weight="bold" content="Smart Suggestions" />
            <Text
              weight=""
              content="Stay ahead with proactive recommendations. Talent Rediscovery suggests past applicants who might be a perfect fit even before you start searching for new roles."
              color="neutral"
            />
          </_Builtin.Block>
        </_Builtin.Block>
