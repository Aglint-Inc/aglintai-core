...
if (process.env.CI === 'true') {
  const DB_SECRETS = JSON.parse(atob(process.env.DEV_DB_SECRETS!));
  process.env.NEXT_PUBLIC_SUPABASE_URL = DB_SECRETS.NEXT_PUBLIC_SUPABASE_URL;
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY =
    DB_SECRETS.NEXT_PUBLIC_SUPABASE_ANON_KEY;
  process.env.SUPABASE_JWT_SECRET = DB_SECRETS.SUPABASE_JWT_SECRET;
  process.env.SUPABASE_SERVICE_ROLE_KEY = DB_SECRETS.SUPABASE_SERVICE_ROLE_KEY;
}
