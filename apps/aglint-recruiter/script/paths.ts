export const PATHS = [
  ...
  '/api/job/jobApplications/candidateDelete',
  ...
  '/api/support/email',
  '/api/support/getApplicationData',
  ...
  'api/emails/phoneScreenRemind_email_applicant',
  'api/emails/phoneScreen_email_candidate',
  'api/emails/preview',
