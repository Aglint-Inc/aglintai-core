...
export function TaskUpdateButton({
  ...
  return (
    <_Component className={_utils.cx(_styles, "div-block-1607")} tag="div">
      <_Builtin.Block
        className={_utils.cx(_styles, "div-block-1608")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-1611", "cursor-pointer")}
          tag="div"
          {...onClickClose}
        >
          <_Builtin.HtmlEmbed
        ...
        <_Builtin.Block tag="div">{textTaskSelected}</_Builtin.Block>
      </_Builtin.Block>
      <_Builtin.Block
        className={_utils.cx(_styles, "div-block-1609")}
        tag="div"
      >
        <ButtonSoft
