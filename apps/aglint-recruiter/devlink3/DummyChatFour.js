...
import _styles from "./DummyChatFour.module.css";

export function DummyChatFour({ as: _Component = _Builtin.Block }) {
  return (
        ...
        >
          <_Builtin.Block className={_utils.cx(_styles, "chat_text")} tag="div">
            ...
            <_Builtin.Block tag="div">
              {
                "I'm looking for a Data Scientist with expertise in machine learning for our Boston office. They should have a PhD in a related field."
              }
            </_Builtin.Block>
          </_Builtin.Block>
        </_Builtin.Block>
      ...
      <_Builtin.Block className={_utils.cx(_styles, "chat_block")} tag="div">
        ...
        >
          <_Builtin.Block className={_utils.cx(_styles, "chat_text")} tag="div">
            ...
            <_Builtin.Block tag="div">
              {
                "Understood. Are there any specific skills or industries you'd like me to focus on?"
              }
            </_Builtin.Block>
          </_Builtin.Block>
        </_Builtin.Block>
      ...
      <_Builtin.Block className={_utils.cx(_styles, "chat_block")} tag="div">
        ...
        >
          <_Builtin.Block className={_utils.cx(_styles, "chat_text")} tag="div">
            ...
            <_Builtin.Block tag="div">
              {
                "Experience in the healthcare industry would be valuable, and proficiency in R and Python is a must."
              }
            </_Builtin.Block>
          </_Builtin.Block>
        </_Builtin.Block>
      ...
      <_Builtin.Block className={_utils.cx(_styles, "chat_block")} tag="div">
        ...
        >
          <_Builtin.Block className={_utils.cx(_styles, "chat_text")} tag="div">
            ...
            <_Builtin.Block tag="div">
              {
                "Got it. I'll search for candidates who fit this profile and provide you with a summary shortly."
              }
            </_Builtin.Block>
          </_Builtin.Block>
        </_Builtin.Block>
      ...
      <_Builtin.Block className={_utils.cx(_styles, "chat_block")} tag="div">
        ...
        >
          <_Builtin.Block className={_utils.cx(_styles, "chat_text")} tag="div">
            ...
            <_Builtin.Block tag="div">
              {
                "I've found 15 candidates that match your criteria. Here's a summary of the top 3:"
              }
            </_Builtin.Block>
          </_Builtin.Block>
          <_Builtin.Block
          ...
          >
            <_Builtin.Block
              ...
              id={_utils.cx(
                _styles,
                "w-node-_60e9b28e-dd33-c12e-35d9-e4ce24cd65b0-24cd6572"
              )}
              tag="div"
            >
              <_Builtin.Block
              ...
              <_Builtin.Block tag="div">
                {
                  "PhD in Computer Science, 5 years of experience in healthcare, "
                }
            ...
            <_Builtin.Block
              ...
              id={_utils.cx(
                _styles,
                "w-node-_60e9b28e-dd33-c12e-35d9-e4ce24cd65ba-24cd6572"
              )}
              tag="div"
            >
              <_Builtin.Block
              ...
              <_Builtin.Block tag="div">
                {"PhD in Data Science, 6 years of experience, "}
                <_Builtin.Span className={_utils.cx(_styles, "fw-semibold")}>
            ...
            <_Builtin.Block
              ...
              id={_utils.cx(
                _styles,
                "w-node-_60e9b28e-dd33-c12e-35d9-e4ce24cd65c4-24cd6572"
              )}
              tag="div"
            >
              <_Builtin.Block
              ...
              <_Builtin.Block tag="div">
                {"PhD in Statistics, 7 years of experience, "}
                <_Builtin.Span className={_utils.cx(_styles, "fw-semibold")}>
                  {"expertise in R, Python, and healthcare analytics."}
                </_Builtin.Span>
              </_Builtin.Block>
            </_Builtin.Block>
          </_Builtin.Block>
      ...
      <_Builtin.Block className={_utils.cx(_styles, "chat_block")} tag="div">
        ...
        >
          <_Builtin.Block className={_utils.cx(_styles, "chat_text")} tag="div">
            ...
            <_Builtin.Block tag="div">
              {"Perfect! Can we send a email reachout to these candidates?"}
            </_Builtin.Block>
          </_Builtin.Block>
        </_Builtin.Block>
      </_Builtin.Block>
      <_Builtin.Block className={_utils.cx(_styles, "chat_block")} tag="div">
        ...
        >
          <_Builtin.Block className={_utils.cx(_styles, "chat_text")} tag="div">
            ...
            <_Builtin.Block tag="div">
              {
                "Certainly. Would you like to use your apply reachout template for this email?"
              }
            </_Builtin.Block>
          </_Builtin.Block>
        </_Builtin.Block>
      ...
      <_Builtin.Block className={_utils.cx(_styles, "chat_block")} tag="div">
        ...
        >
          <_Builtin.Block className={_utils.cx(_styles, "chat_text")} tag="div">
            ...
            <_Builtin.Block tag="div">
              {
                "The LinkedIn reachout messages have been sent using the personalized template."
              }
            </_Builtin.Block>
          </_Builtin.Block>
        </_Builtin.Block>
