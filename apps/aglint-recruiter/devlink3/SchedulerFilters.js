...
export function SchedulerFilters({
  ...
  singleDaySchedule,
  slotPreferdInterviewerInput,
  slotSelectedTimeRanges,
  slotSelectedTiimeRangeInput,
  slotWorkloadPreference,
  slotToggleWithText,
  textNoConflicts = "126",
  onClickChangeDate = {},
  textSoftConflicts = "64",
  textHardConflicts = "12",
  textOutsideWorkHours = "84",
}) {
  return (
    <_Component
    ...
    >
      ...
      >
        ...
        />
        <_Builtin.Block tag="div">{"April 04 - April 05"}</_Builtin.Block>
        <_Builtin.HtmlEmbed
          className={_utils.cx(_styles, "embed_flex")}
      ...
      <_Builtin.Block tag="div">{slotWorkloadPreference}</_Builtin.Block>
    </_Component>
  );
}
