...
export function WorkflowCard({
  ...
  return (
    ...
    >
      {isCheckboxVisible ? (
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-1756")}
          tag="div"
        >
          {slotCheckbox}
        </_Builtin.Block>
      ) : null}
      <_Builtin.Block className={_utils.cx(_styles, "workflow_card")} tag="div">
        <_Builtin.Block className={_utils.cx(_styles, "wc_top")} tag="div">
          <_Builtin.Block
        ...
        <_Builtin.Block className={_utils.cx(_styles, "wc_bottom")} tag="div">
          <_Builtin.Block
          ...
          >
            ...
            >
              ...
              />
              <_Builtin.Block tag="div">{textWorkflowTrigger}</_Builtin.Block>
            </_Builtin.Block>
          </_Builtin.Block>
          <_Builtin.Block
