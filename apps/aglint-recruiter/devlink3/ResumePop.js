...
import _styles from "./ResumePop.module.css";
...
export function ResumePop({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "assessment_duplicate_popup", "width-463")}
      tag="div"
    >
      <_Builtin.Block className={_utils.cx(_styles, "popup_header")} tag="div">
        <_Builtin.Block className={_utils.cx(_styles, "popup_title")} tag="div">
          ...
          <Text weight="bold" color="warning" content="Resume" />
        </_Builtin.Block>
        <_Builtin.Block
      ...
      <_Builtin.Block className={_utils.cx(_styles, "callout")} tag="div">
        <Text content={textResumeWarning} weight="" color="warning" />
      </_Builtin.Block>
