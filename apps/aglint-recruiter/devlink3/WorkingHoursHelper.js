...
export function WorkingHoursHelper({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "working-hour-helper-wrap")}
      tag="div"
    >
      <_Builtin.Block
      ...
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "wroking-helper-sub-wrap")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "whh-info-block")}
            tag="div"
          >
            <_Builtin.Block
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "whh-info-block", "is_neutral")}
            tag="div"
          >
            <_Builtin.Block
