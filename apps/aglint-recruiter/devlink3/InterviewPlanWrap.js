...
export function InterviewPlanWrap({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "ipw-parent-wrap")}
    ...
    >
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "ipw-arrow-wrap")}
        tag="div"
      >
        {isTopArrowVisible ? (
          <_Builtin.Block tag="div" {...onClickUp}>
            <IconButtonSoft color="neutral" iconName="arrow_upward" />
          </_Builtin.Block>
        ) : null}
        {isBottomArrowVisible ? (
          <_Builtin.Block tag="div" {...onClickDown}>
            <IconButtonSoft color="neutral" iconName="arrow_downward" />
          </_Builtin.Block>
        ) : null}
      </_Builtin.Block>
    </_Component>
