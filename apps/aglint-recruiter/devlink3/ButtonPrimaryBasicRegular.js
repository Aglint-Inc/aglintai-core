...
import _styles from "./ButtonPrimaryBasicRegular.module.css";

export function ButtonPrimaryBasicRegular({
  ...
  return (
    ...
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "button-block", "primary", "basic")}
        tag="div"
      >
