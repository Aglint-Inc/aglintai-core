...
export function ConfirmScheduleListCard({
  as: _Component = _Builtin.Block,
  slotIconPanel,
  textPanelName = "Personality and cultural fit",
  textTime = "09:00AM - 09:30PM PST",
  slotMeetingIcon,
  textMeetingPlatformName = "Google Meet",
  textDuration = "30 Minutes",
}) {
  return (
    <_Component className={_utils.cx(_styles, "div-block-1764")} tag="div">
      <_Builtin.Block
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "div-block-1767")}
        tag="div"
      >
        <_Builtin.Block
