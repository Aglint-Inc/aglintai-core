    ...
    >
      ...
      >
        ...
        >
          ...
          {isRatingVisible ? (
            <_Builtin.Block
              className={_utils.cx(_styles, "div-block-1579")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "div-block-1580")}
                tag="div"
                {...onClickVerySatisfy}
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "div-block-1578")}
                  tag="div"
                >
                  <_Builtin.Image
                  ...
                  />
                  <_Builtin.Block
                    className={_utils.cx(_styles, "text-sm", "relative-1")}
                    tag="div"
                  >
                    {"Very Satisfied"}
                  </_Builtin.Block>
                ...
                {isVerySatisfiedActive ? (
                  <_Builtin.Block
                    className={_utils.cx(_styles, "div-block-1581")}
                    tag="div"
                  />
                ) : null}
              </_Builtin.Block>
          ...
          {isRatingVisible ? (
            <_Builtin.Block
              className={_utils.cx(_styles, "div-block-1583")}
              tag="div"
              {...onClickSubmit}
            >
              <ButtonSolid
          ...
          {isThankYouVisible ? (
            <_Builtin.Block
              className={_utils.cx(_styles, "div-block-1586")}
              tag="div"
            >
              <_Builtin.HtmlEmbed
              ...
              />
              <_Builtin.Block
                className={_utils.cx(_styles, "div-block-1587")}
                tag="div"
              >
                <_Builtin.Block
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "div-block-1585")}
        tag="div"
      >
        <_Builtin.Block
