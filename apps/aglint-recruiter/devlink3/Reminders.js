      ...
      >
        ...
        >
          {slotCandidateReminder ?? (
            <>
              <_Builtin.Block
                className={_utils.cx(_styles, "reminder-list-wrap")}
                data-w-id="4f356960-8d7f-a7bc-698e-96c6c94f7cdb"
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "reminder-list-left")}
                  tag="div"
                >
                  <_Builtin.HtmlEmbed
                ...
                <_Builtin.Block
                  className={_utils.cx(_styles, "reminder-list-right")}
                  tag="div"
                >
                  <_Builtin.HtmlEmbed
