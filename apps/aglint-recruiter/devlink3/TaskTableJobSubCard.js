...
export function TaskTableJobSubCard({
  ...
  return (
    ...
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "tjsc-checkbox-wrap")}
        id={_utils.cx(
          _styles,
