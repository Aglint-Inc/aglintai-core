...
export function SavedList({
  ...
  return (
    ...
    >
      {isCardVisible ? (
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-728", "width-auto")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "div-block-939", "width-auto")}
            tag="div"
          >
            <_Builtin.HtmlEmbed
      ...
      {isSavedListInputVisible ? (
        ...
        >
          ...
          >
            ...
            />
            <_Builtin.Block
              className={_utils.cx(_styles, "div-block-942")}
              tag="div"
            >
              {slotInputTextSavedList}
            </_Builtin.Block>
