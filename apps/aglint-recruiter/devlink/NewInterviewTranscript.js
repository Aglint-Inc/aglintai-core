...
import _styles from "./NewInterviewTranscript.module.css";

export function NewInterviewTranscript({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "int-transcript-sidebar-wrapper")}
      tag="div"
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "int-transcript-sidebar-block")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "int-ts-header-block")}
          tag="div"
        >
          <_Builtin.Block
