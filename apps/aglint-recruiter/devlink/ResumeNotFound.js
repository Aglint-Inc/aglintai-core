...
import _styles from "./ResumeNotFound.module.css";
...
export function ResumeNotFound({
  ...
  return (
    <_Component
      ...
      id={_utils.cx(
        _styles,
        "w-node-_26c60c6a-1280-4800-dd3f-fd87cb99b41f-cb99b41f"
      )}
      tag="div"
    >
      <_Builtin.Block className={_utils.cx(_styles, "flex-h4")} tag="div">
        ...
        />
        <Text content="Resume not found" color="neutral-12" weight="medium" />
      </_Builtin.Block>
      <_Builtin.VFlex className={_utils.cx(_styles, "flex-center")} tag="div">
        <Text
          content={
            <>
              {"Unable to find the candidate resume. "}
              <br />
              {
                "Please upload the resume manually to generate a score and analyse the candidate's profile."
              }
            </>
          }
          color="neutral"
