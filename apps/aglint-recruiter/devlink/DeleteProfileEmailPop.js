...
import _styles from "./DeleteProfileEmailPop.module.css";
...
export function DeleteProfileEmailPop({
  ...
  return (
    <_Component className={_utils.cx(_styles, "change-email-pop")} tag="div">
      ...
      <_Builtin.Block tag="div">
        {"We will send you a link to confirm the change."}
      </_Builtin.Block>
      <_Builtin.Block
      ...
      >
        ...
        >
          ...
          >
            ...
            <_Builtin.Block tag="div" {...onClickSendLink}>
              <ButtonOutlinedSmall textLabel="Send Link" />
            </_Builtin.Block>
          </_Builtin.Block>
        </_Builtin.Block>
      </_Builtin.Block>
