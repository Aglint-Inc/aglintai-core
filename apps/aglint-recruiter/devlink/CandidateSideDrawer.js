  ...
  return (
    ...
    >
      <_Builtin.Block className={_utils.cx(_styles, "div-block-714")} tag="div">
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-981")}
          tag="div"
        >
          {isHeaderVisible ? (
            <_Builtin.Block
              ...
              {isFullWidthVisible ? (
                ...
                >
                  ...
                  >
                    {isNameImageVisible ? (
                      <_Builtin.Block
                        className={_utils.cx(_styles, "div-block-787", "pl-16")}
                        tag="div"
                      >
                        <_Builtin.Block
                          className={_utils.cx(
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-982")}
          tag="div"
          {...propsStyle}
        >
          <_Builtin.Block
