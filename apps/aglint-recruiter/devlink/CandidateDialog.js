...
import { CandidateSidedrawerTop } from "./CandidateSidedrawerTop";
...
export function CandidateDialog({
  ...
  return (
    <_Component className={_utils.cx(_styles, "cd-side-wrap")} tag="div">
      <_Builtin.Block
        className={_utils.cx(_styles, "cv-sidebar-header-wrapper")}
        tag="div"
      >
        <_Builtin.Block tag="div">
          <_Builtin.Block
            className={_utils.cx(_styles, "candidate_name")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "name_and_avatar")}
              tag="div"
            >
              <_Builtin.HtmlEmbed
        ...
        >
          <CandidateSidedrawerTop
            onClickDown={onClickNext}
            onClickUp={onClickPrev}
            onClickClose={onClickClose}
            onClickBookMark={onClickStar}
            isBookmarked={isStarActive}
          />
        </_Builtin.Block>
      </_Builtin.Block>
      <_Builtin.Block className={_utils.cx(_styles, "div-block-993")} tag="div">
        <_Builtin.Block
        ...
        >
          <_Builtin.Block tag="div">
            ...
            >
              ...
              {isOverviewVisible ? (
                <_Builtin.Block
                  className={_utils.cx(_styles, "cd-overview-wrap")}
                  tag="div"
                >
                  <CandidateOverview textOverview={textOverview} />
                </_Builtin.Block>
              ) : null}
            </_Builtin.Block>
          </_Builtin.Block>
