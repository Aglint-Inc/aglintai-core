...
import _styles from "./ScorePillMust.module.css";
...
export function ScorePillMust({
  ...
  return (
    <_Component
      className={_utils.cx(_styles, "skills-must-wrapps")}
      data-w-id="627f9dba-f186-82c1-a71f-5a95f8ccc427"
      tag="div"
      {...onClickEditText}
    >
