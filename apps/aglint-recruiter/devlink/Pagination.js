...
export function Pagination({
  ...
  return (
    <_Component className={_utils.cx(_styles, "jp-nav-wrapper-cd")} tag="div">
      <_Builtin.Block
        className={_utils.cx(_styles, "pagination-text-wrap")}
        tag="div"
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "jp-nav-btn-block")}
          tag="div"
        >
          <_Builtin.Block
          ...
          <_Builtin.Block
            ...
            tag="div"
          >
            <Text content={textCurrentPageCount} />
          </_Builtin.Block>
          <_Builtin.Block
          ...
          >
            <Text content="of" />
            <Text content={textTotalPageCount} />
          </_Builtin.Block>
          <_Builtin.Block
            className={_utils.cx(_styles, "jb-nav-icon")}
            tag="div"
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "jp-nav-block")}
          tag="div"
        >
          <Text content="Showing" color="neutral" />
          <Text content={textCurrentCandidateCount} color="neutral" />
          <Text content="of" color="neutral" />
          <Text content={textTotalCandidateCount} color="neutral" />
          <Text content="candidates" color="neutral" />
        </_Builtin.Block>
      </_Builtin.Block>
    </_Component>
  );
