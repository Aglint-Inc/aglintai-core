    ...
    <_Component className={_utils.cx(_styles, "jd-analysis-wrap")} tag="div">
      ...
      >
        ...
        >
          ...
          <Text content={textExperienceDesc} color="neutral" />
        </_Builtin.Block>
        <_Builtin.Block
          className={_utils.cx(_styles, "jd-analysis-item-wrap")}
          tag="div"
        >
          ...
          <Text content={textSkillDesc} color="neutral" />
        </_Builtin.Block>
        <_Builtin.Block
          className={_utils.cx(_styles, "jd-analysis-item-wrap")}
          tag="div"
        >
          ...
          <Text content={textEducationDesc} color="neutral" />
        </_Builtin.Block>
      </_Builtin.Block>
    </_Component>
  );
