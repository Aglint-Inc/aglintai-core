...
export const interviewer_leaderboard = privateProcedure
  .input(body)
  .query(async ({ input }) => {
    ...
    return (
      await adminDb
        .rpc('interviewers_leaderboard_by_v', {
...
export type InterviewerLeaderboard = ProcedureDefinition<
  typeof interviewer_leaderboard
>;
