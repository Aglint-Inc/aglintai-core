  ...
  const response = (
    (
      await db
        .from('applications')
        .select(
          'id,interview_meeting!inner(*,interview_session!inner(*,interview_plan!inner(*),interview_session_relation!inner(feedback))),candidates!inner(*),public_jobs!inner(id,job_title)',
        )
