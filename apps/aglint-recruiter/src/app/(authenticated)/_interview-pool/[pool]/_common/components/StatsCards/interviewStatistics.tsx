        ...
        <CardContent>
          <div className='space-y-2'>
            <div className='flex justify-between'>
              ...
              <span className='font-bold text-gray-900'>{isFetched?data.total:<Skeleton className='h-6 w-10'/>}</span>
            </div>
            <div className='flex justify-between'>
              <span className='text-gray-600'>Completion Rate</span>
              <span className='font-bold text-green-600'>{isFetched?`${Number((data.completed/data.total)*10000)/100} %`:<Skeleton className='h-6 w-10'/>}</span>
            </div>
            <div className='flex justify-between'>
              <span className='text-gray-600'>Avg. Duration</span>
              <span className='font-bold text-gray-900'>{isFetched?`${data.duration} min`:<Skeleton className='h-6 w-10'/>}</span>
            </div>
            <div className='flex justify-between'>
