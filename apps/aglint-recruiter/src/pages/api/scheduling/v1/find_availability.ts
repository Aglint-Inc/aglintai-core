...
import { createPagesApiRoute } from '@/utils/apiUtils/createPagesApiRoute';
...
type FuncParams = z.infer<typeof schema_find_availability_payload>;
const find_availability = async (payload: FuncParams) => {
  const parsedData: FuncParams = {
    ...payload,
...
const handler = createPagesApiRoute(
