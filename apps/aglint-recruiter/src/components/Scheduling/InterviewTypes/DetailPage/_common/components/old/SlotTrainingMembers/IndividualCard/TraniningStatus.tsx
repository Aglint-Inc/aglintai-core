  ...
  export function TrainingStatus({
    ...
    return (
      <div className='flex flex-col items-start '>
        {isCompletedVisible && (
          <div className='flex items-center gap-1 bg-green-100 text-green-800 px-3 py-1 rounded-sm'>
            {isShadow && <ShadowIcon />}
        ...
        {isPendingApprovalVisible && (
          <div className='flex items-center gap-1 bg-orange-100 text-orange-800 px-3 py-1 rounded-sm'>
            {isReverseShadow && <ReverseShadowIcon />}
            {isShadow && <ShadowIcon />}
        ...
        {isNotCompletedVisible && (
          <div className='flex items-center gap-1 bg-gray-100 text-gray-800 px-3 py-1 rounded-sm'>
            {isShadow && <ShadowIcon />}
            {isReverseShadow && <ReverseShadowIcon />}
