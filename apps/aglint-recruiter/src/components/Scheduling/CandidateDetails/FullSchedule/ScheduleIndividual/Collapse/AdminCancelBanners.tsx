      ...
      {adminCancel.map((cancel) => {
        return (
          <GlobalBanner
            ...
            color={'error'}
            textTitle={`${cancel.recruiter_user.id === recruiterUser.user_id ? 'You have' : getFullName(cancel.recruiter_user.first_name, cancel.recruiter_user.last_name)} cancelled this schedule`}
