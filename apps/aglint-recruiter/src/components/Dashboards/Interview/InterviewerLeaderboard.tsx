...
import { Trophy, Clock, Users, ThumbsUp, Zap, BarChart } from "lucide-react"
...
const leaderboardData = [
  ...
  { 
    ...
    hiringRate: 68,
    averageScore: 4.7,
    topSkills: ["Facility Management", "Team Coordination", "Process Optimization"]
  },
  { 
    rank: 3, 
...
export default function ComprehensiveInterviewerLeaderboard() {
  ...
  const sortedData = [...leaderboardData].sort((a, b) => {
    ...
    if (sortBy === "satisfactionRate") return b.satisfactionRate - a.satisfactionRate
          ...
          <div className="flex items-center space-x-2">
            <Select value={sortBy} onValueChange={setSortBy}>
              ...
              <SelectContent>
                ...
                <SelectItem value="satisfactionRate">Acceptence Rate</SelectItem>
        ...
        <CardContent>
          <div className="space-y-6">
            {sortedData.map((interviewer) => (
              <div key={interviewer.rank} className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4 bg-muted p-4 rounded-lg">
                <div className="flex w-[50%] items-center space-x-4">
                  ...
                  <div className="relative">
                    <Avatar className="h-16 w-16 border-2 border-primary">
                      <AvatarImage src={interviewer.avatar} alt={interviewer.name} className="rounded-full object-cove rounded-fullr" />
                      <AvatarFallback className="rounded-full">{interviewer.name.split(' ').map(n => n[0]).join('')}</AvatarFallback>
                    </Avatar>
                    ...
                    <Tooltip>
                      <TooltipTrigger>
                        <div className="flex flex-col items-center p-2 bg-background rounded-md">
                          ...
                          <span className="text-lg font-semibold">{interviewer.hours.toFixed(1)}</span>
                    ...
                    <Tooltip>
                      <TooltipTrigger>
                        <div className="flex flex-col items-center p-2 bg-background rounded-md">
                          ...
                          <span className="text-lg font-semibold">{interviewer.interviews}</span>
                    ...
                    <Tooltip>
                      <TooltipTrigger>
                        <div className="flex flex-col items-center p-2 bg-background rounded-md">
                          ...
                          <span className="text-lg font-semibold">{interviewer.satisfactionRate}%</span>
                          <span className="text-xs text-muted-foreground">Accepence Rate</span>
                        </div>
                      </TooltipTrigger>
                      <TooltipContent>
                    ...
                    <Tooltip>
                      <TooltipTrigger>
                        <div className="flex flex-col items-center p-2 bg-background rounded-md">
                          ...
                          <span className="text-lg font-semibold">{interviewer.hiringRate}%</span>
                          <span className="text-xs text-muted-foreground">Decline Rate</span>
                        </div>
                      </TooltipTrigger>
                      <TooltipContent>
                    ...
                    <Tooltip>
                      <TooltipTrigger>
                        <div className="flex flex-col items-center p-2 bg-background rounded-md">
                          ...
                          <span className="text-lg font-semibold">{interviewer.averageScore}</span>
