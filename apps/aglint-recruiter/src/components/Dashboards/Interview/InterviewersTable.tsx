          ...
          <TableHeader>
            <TableRow>
              <TableHead className="w-[250px]">
                Interviewer Name <ArrowDownIcon className="inline-block h-4 w-4 ml-1" />
              </TableHead>
              <TableHead className="text-right">Upcoming</TableHead>
              <TableHead className="text-right">Completed</TableHead>
              <TableHead className="text-right">Hours of interviews completed</TableHead>
          ...
          <TableBody>
            {interviewers.map((interviewer) => (
              <TableRow key={interviewer.email}>
                ...
                <TableCell className="text-right">{interviewer.completed}</TableCell>
                <TableCell className="text-right">{interviewer.hoursCompleted}</TableCell>
                <TableCell className="text-right">{interviewer.declines}</TableCell>
                <TableCell className="text-right">{interviewer.avgWeeklyInterviews}</TableCell>
                <TableCell className="text-right">{interviewer.avgWeeklyHours}</TableCell>
                <TableCell className="text-right">{interviewer.modulesTrained}</TableCell>
                <TableCell className="text-right">{interviewer.modulesInTraining}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
