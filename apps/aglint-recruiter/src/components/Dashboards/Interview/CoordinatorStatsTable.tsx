...
export default function CoordinatorStatsTable() {
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl font-bold">Coordinator Statistics</CardTitle>
      </CardHeader>
      <CardContent>
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-right">
                Scheduled <ArrowDownIcon className="inline-block h-4 w-4 ml-1" />
              </TableHead>
          ...
          <TableBody>
            {coordinators.map((coordinator) => (
              <TableRow key={coordinator.name}>
                ...
                <TableCell className="text-right">{coordinator.scheduled}</TableCell>
                <TableCell className="text-right">{coordinator.cancel}</TableCell>
                <TableCell className="text-right">{coordinator.decline}</TableCell>
                <TableCell className="text-right">{coordinator.reschedule}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
