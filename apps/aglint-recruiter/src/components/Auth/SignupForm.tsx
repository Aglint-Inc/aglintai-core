...
const validateEmail = (email: string) => {
  const personalEmailPattern = /^(gmail\.com|yahoo\.com|outlook\.com|hotmail\.com)$/;
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              {...register('email', {
                ...
                validate: (value) => !handleEmail(value).error || handleEmail(value).msg
              })}
            />
            ...
            <div className="relative">
              <Input
                ...
                {...register('password', {
                  ...
                  validate: (value) => !handlePassword(value).error || handlePassword(value).msg
                })}
              />
              <Button
