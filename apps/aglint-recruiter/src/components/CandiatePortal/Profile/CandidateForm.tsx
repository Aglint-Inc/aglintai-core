...
export default function CandidateForm() {
  ...
  const [bio, setBio] = useState('A passionate developer with 5 years of experience...')
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
      <Card className="w-full max-w-2xl">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">Candidate Profile</CardTitle>
        </CardHeader>
        <CardContent>
              ...
              {resume && (
                <div className="flex items-center space-x-2 mt-2">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => window.open(URL.createObjectURL(resume), '_blank')}
                  >
                    View
                  </Button>
                </div>
  ...
  return (
    <div className={className}>
      <label className="block">
        ...
        <input type="file" accept={accept} onChange={handleFileChange} className="block w-full text-sm text-gray-500
