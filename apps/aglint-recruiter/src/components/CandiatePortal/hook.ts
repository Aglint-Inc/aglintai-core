...
import { type apiResponsePortalCompany } from '@/app/api/candidate_portal/get_company/route';
...
import { type apiHomepageResponse } from '@/app/api/candidate_portal/home_page/route';
