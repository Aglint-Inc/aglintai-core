  ...
  return (
      <div className="w-full max-w-md bg-white rounded-lg shadow-md overflow-hidden">
        <div className="relative h-40 bg-cyan-50">
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 160" xmlns="http://www.w3.org/2000/svg">
            <path d="M0,80 Q100,20 200,80 T400,80" fill="none" stroke="#3B82F6" strokeWidth="2" />
        ...
        <div className="p-8 pt-16">
          <h1 className="text-2xl font-bold text-center mb-2">Check your email for a code</h1>
          <p className="text-gray-600 text-center mb-6">
            Please insert below the verification code that was sent to<br />
            bri****@modernloop.xyz
          </p>
