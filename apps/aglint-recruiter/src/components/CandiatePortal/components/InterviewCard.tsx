        ...
        <CardContent className="p-6">
          <div className="flex items-stretch space-x-6">
            <div className="flex flex-col items-center justify-center bg-gray-100 py-3 rounded-lg w-28">
              <span className="text-sm font-medium text-gray-500">{interviewData.month}</span>
              <span className="text-4xl font-medium my-1">{interviewData.date}</span>
              <span className="text-sm font-medium text-gray-500">{interviewData.day}</span>
            </div>
            <div className="flex-1 flex flex-col justify-center space-y-2">
                <div className='flex items-center gap-2'>
                <h2 className="text-xl font-semibold">{interviewData.type}</h2>
                <Badge variant={'secondary'} className='font-normal rounded-md'>{interviewData.status}</Badge>
                </div>
