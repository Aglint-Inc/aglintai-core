        ...
        <CardHeader className='p-0 pt-4 pl-4 pb-4'>
          ...
          <div className='flex gap-2 items-center'>
            <div className='text-sm '>
              You&apos;re all set for the recruitment process! You&apos;ll receive
              all the details right here in the portal. Please make sure your
              profile is up-to-date and keep an eye out for updates.
            </div>
          </div>
        </CardHeader>
