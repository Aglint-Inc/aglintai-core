    ...
    <footer>
      {brand && (
        <Box display="flex" alignItems="center" justifyContent="center">
          <Typography variant="body2" color="var(--neutral-11)" display="flex" alignItems="center">
            Powered by
            <SvgIcon style={{ marginLeft: 4, marginRight: 8 }}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="16" height="16" rx="2" fill="#FF9C00" fill-opacity="0.160784"/>
