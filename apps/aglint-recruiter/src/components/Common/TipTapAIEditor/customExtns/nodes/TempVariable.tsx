  ...
  addOptions() {
    return {
      ...
      renderText({ options, node }) {
        return `${options.suggestion.char}${node.attrs.label ?? node.attrs.id}${options.suggestion.end_char}`;
      },
      ...
      renderHTML({ options, node }) {
        return [
          ...
          `${options.suggestion.char}${node.attrs.label ?? node.attrs.id}${options.suggestion.end_char}`,
        ];
      },
      suggestion: {
        end_char: '}}',
